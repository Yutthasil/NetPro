...
with client.invoke_shell() as ssh:
    ...
    ssh.send("int g0/2\n")
    time.sleep(1)
    ssh.send("ip addr dhcp\n")
    time.sleep(1)
    ssh.send("no shut\n")
    time.sleep(1)
    ssh.send("int g0/1\n")
    time.sleep(1)
    ssh.send("ip addr 172.31.102.49 255.255.255.240\n")
    time.sleep(1)
    ssh.send("no shut\n")
    time.sleep(1)
...
with client.invoke_shell() as ssh:
    ...
    ssh.send("int g0/2\n")
    time.sleep(1)
    ssh.send("ip addr 172.31.102.50 255.255.255.240\n")
    time.sleep(1)
    ssh.send("no shut\n")
    time.sleep(1)
    ssh.send("int g0/1\n")
    time.sleep(1)
    ssh.send("ip addr 172.31.102.33 255.255.255.240\n")
    time.sleep(1)
    ssh.send("no shut\n")
    time.sleep(1)
    ssh.send("router ospf 10 vrf control-data\n")
...
with client.invoke_shell() as ssh:
    ...
    ssh.send("int g0/2\n")
    time.sleep(1)
    ssh.send("ip addr 172.31.102.34 255.255.255.240\n")
    time.sleep(1)
    ssh.send("no shut\n")
    time.sleep(1)
    ssh.send("router ospf 10 vrf control-data\n")
